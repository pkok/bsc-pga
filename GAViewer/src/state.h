...
//	int existConsoleFunction(const char *name);
	...
	int addL3gaObject(const l3ga &mv, const std::string &name, int drawMode = 0, int creationFlags = 0, int forceFlags = 0);
...
//	int m_clippingPlanesEnabled; // is the world clipped according to 'm_clipDistance'?
	...
	inline int setL3gaFactor(const l3ga &mv, int idx) {return -1;} // todo
