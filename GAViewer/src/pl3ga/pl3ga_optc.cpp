...
void pl3gai_null(double *dest, int length) {
	memset(dest, 0, length * sizeof(double));
}

void pl3gai_general_gp(const double *a[], const double *b[], double *c) {
	const double *an, *bn;
	pl3gai_null(c, 16);
	if (an = a[0]) {
		if (bn = b[0]) {
...
void pl3gai_general_lcont(const double *a[], const double *b[], double *c) {
	const double *an, *bn;
	pl3gai_null(c, 16);
	if (an = a[0]) {
		if (bn = b[0]) {
...
void pl3gai_general_op(const double *a[], const double *b[], double *c) {
	const double *an, *bn;
	pl3gai_null(c, 16);
	if (an = a[0]) {
		if (bn = b[0]) {
...
void pl3gai_general_scp(const double *a[], const double *b[], double *c) {
	const double *an, *bn;
	pl3gai_null(c, 16);
	if (an = a[0]) {
		if (bn = b[0]) {
...
void pl3gai_general_hip(const double *a[], const double *b[], double *c) {
	const double *an, *bn;
	pl3gai_null(c, 16);
	if (an = a[1]) {
		if (bn = b[1]) {
...
void pl3gai_general_mhip(const double *a[], const double *b[], double *c) {
	const double *an, *bn;
	pl3gai_null(c, 16);
	if (an = a[0]) {
		if (bn = b[0]) {
...
void pl3gai_general_rcont(const double *a[], const double *b[], double *c) {
	const double *an, *bn;
	pl3gai_null(c, 16);
	if (an = a[0]) {
		if (bn = b[0]) {
...
void pl3gai_opt_om_01x01(const double *a, const double *b, double *c) {
	c[0] = + a[0] * b[0] ;
}

void pl3gai_opt_om_04x04(const double *a, const double *b, double *c) {
...
void pl3gai_opt_om_06x06(const double *a, const double *b, double *c) {
...
void pl3gai_copy(double *dest, const double *src, int length) {
	memcpy(dest, src, length * sizeof(double));
}

void pl3gai_reverse(double *a[]) {
	double *an;
	if (an = a[2]) {
		an[0] = -an[0];
		an[1] = -an[1];
...
void pl3gai_cliffordConjugate(double *a[]) {
	double *an;
	if (an = a[1]) {
		an[0] = -an[0];
		an[1] = -an[1];
...
void pl3gai_involution(double *a[]) {
	double *an;
	if (an = a[1]) {
		an[0] = -an[0];
		an[1] = -an[1];
...
void pl3gai_negate(double *dest, const double *src, int length) {
	int i;
	for (i = 0; i < length; i++)
		dest[i] = -src[i];
}

double pl3gai_norm_a(const double a[], int nb) {
	int i;
	double norm = 0.0;
	for (i = 0; i < nb; i++)
		norm += a[i] * a[i];
...
void pl3gai_addSameGradeUsage(double *c, const double *a, const double *b, int length) {
	int i;
	for (i = 0; i < length; i++)
		c[i] = a[i] + b[i];
}

void pl3gai_add(const double *a[5], const double *b[5], double *c[5]) {
	double const *an, *bn;
	double *cn;
...
void pl3gai_subSameGradeUsage(double *c, const double *a, const double *b, int length) {
	int i;
	for (i = 0; i < length; i++)
		c[i] = a[i] - b[i];
}

void pl3gai_sub(const double *a[5], const double *b[5], double *c[5]) {
	double const *an, *bn;
	double *cn;
