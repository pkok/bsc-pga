...
\askLeo{$\pluckerbilin$ gebruik ik nergens meer. Definitie weghalen?}
...
\begin{equation} \label{eq:Em}
  \Em(A) = \left\{ 
    ...
    \right.
\end{equation}
\note{\LeosReply{nu gebruik je de Em net de andere kant op dan ik geloof ik. Dat is natuurlijk geen probleem, maar het maakt de correspondentie met het internal report even wat minder direct. Dat kan je even zeggen in een voetnoot, ik zou niet meer veranderen.}

\myReply{Maar kan ik wel verwijzen naar het internal report? Zo ja, waar/hoe? En als ik $\Em$ nu andersom gebruik, is het dan alsnog een embedding function?}}
